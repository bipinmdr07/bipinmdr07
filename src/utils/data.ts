...
export const SERVICES = Object.freeze([
  ...
  },
  {
    ...
    icon: "mdi:web",description: "* Aenean in sem ac leo mollis blandit."
  },
  {
    id: 3,
    name: "3D Design",
    icon: "mdi:unity",description: "* Aenean in sem ac leo mollis blandit."
  }
])
...
export const PROJECTS = Object.freeze([
  {
    ...
    tags: ['Booking'],
    html: `Paxsafe is an Australian base company offereing the private apartment accomodations near to Sydney's iconic Hyde Park.
This apartments provide guests with a comfortable and centrally located stay.`,
  ...
  },
  {
    ...
    html: "Language Scientific is a U.S.-based company that provided specialized translation and localization service for medical, scientific, and technical industries. They delivery high-quality translations for medical documents, software localization, eLearning and more.",
    contributions: [
  ...
  },
  {
    ...
    tags: ['Health'],
    html: "gWell Health is a digital health, genomics, and wellness company focused on improving individuals' overall well-bing by providing personalized wellness plans based on DNA analysis, health history, and lifestyle.",
    contributions: [
      ...
      "Worked closely with <b>Design Team</b> and <b>Client</b> to improve the user experience, and understand the value of the product.",
  ...
  },
  {
    ...
    tags: ['Health'],
    html: "Innovaccer referral management is a web application developed by Leapfrog Technologies in collaboration with Innovaccer Inc. The application is used to connect or refer patients to different doctors/specialists in different medical fields inside for outside network, according to the needs of the patients.",
    company: ["Leapfrog", "Innovaccer"],
    contributions: [
      "Lead the front end team and work with team from different geographical location.",
      "Introduced the <b>Finite State Machine</b> implementation as the patient detai page was heavely driven by the status of the patient.",
  ...
  },
  {
    ...
    html: "Aspen Pipeline is a web application aims to provide the scientist involved in drug discovery process with the proper way to manage the information in a systematic way.",
    company: ["Leapfrog", "Aspen Bioscience"],
    contributions: [
  ...
  },
  {
    ...
    tags: ['Health'],
    html: "Trayt is an AI-powered, multifactorial data analytics and clinical decision support platform that expands access to care and help clinics dramatically improve diagnosis and treatment accuracy for patients with neuropsychiatric and medical health conditions.",
...
export const OPENSOURCE_PROJECTS = Object.freeze([
  {
    ...
    tags: ['Open Source'],
    html: "A vs-code extension for sorting the line by its length and grouping the imports to maintain the ladder import structure and make code look visually appealing.",
    contributions: [
      "Define a keyboard shortcut to execute the sorting function in ascending and descenting order."
    ]
  },
  {
    ...
    tech: ['javascript', 'vscode'],
    tags: ['Open Source'],
    html: "A vs-code extension for providing a snippet defining a class or function for lit-element.",
    contributions: [
  ...
  },
  {
    ...
    tags: ['Open Source'],
    html: "A web application for view the local and remote dynamodb data.",
    contributions: [
